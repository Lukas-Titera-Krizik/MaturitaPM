...
<form class="formular" action="registration_script.php" method="post">
  <div class="container">

    <label><b>Jméno</b></label><br>
    <input type="text" placeholder="Jméno..." name="name" required><br>

    <label><b>Příjmení</b></label><br>
    <input type="text" placeholder="Příjmení..." name="surname" required><br>

    <label><b>E-mail</b></label><br>
    <input type="email" placeholder="E-mail..." name="email" required><br>

      <label><b>Telefonní číslo</b></label><br>
      <input type="number" placeholder="Telefon..." name="phone" min="100000000" max="999999999" required><br>

    <label><b>Heslo</b></label><br>
    <input type="password" placeholder="Heslo..." name="psw" required><br>

    <button type="submit" name="submit">Vytvořit účet</button><br>

    <a id="Register">Již máte účet? </a><a id="RegisterOdkaz" href="login.php">Přihlásit</a>
  </div>
</form>
