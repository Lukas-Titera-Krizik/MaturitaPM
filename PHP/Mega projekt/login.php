...
<form class="formular" action="login_script.php" method="post">
  <div class="container">

    <label><b>E-mail</b></label><br>
    <input type="email" placeholder="Uživatelské jméno..." name="email" required><br>

    <label><b>Heslo</b></label><br>
    <input type="password" placeholder="Heslo..." name="psw" required><br>

    <button type="submit" name="submit">Přihlásit</button><br>

    <a id="Register">Ještě nemáte účet? </a><a id="RegisterOdkaz" href="registration.php">Registrovat</a>
  </div>
</form>
