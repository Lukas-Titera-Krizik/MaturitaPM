...
<form class="vetsi" action="add_product_script.php" method="post" enctype="multipart/form-data">

  <div class="container">
      <h1>Přidat produkt</h1><br>

    <label><b>Název</b></label><br>
    <input type="text" placeholder="Název..." name="name" required><br>

    <label><b>Velikost</b></label><br>
    <input type="text" placeholder="Velikost... (ve formátu S, M, L, XL)" name="size" required><br>

    <label><b>Cena</b></label><br>
    <input type="number" placeholder="Cena... (ve formátu 1000)" name="price" required><br>

    <label><b>Popisek</b></label><br>
    <input type="text" placeholder="Popisek..." name="description" required><br>


      <label><b>Obrázek</b></label><br>
      <input type="file" name="picture" accept="image/*" required><br>

    <button type="submit" name="submit">Odeslat</button><br>

  </div>
</form>

<form class="mensi" action="add_category_script.php" method="post" enctype="multipart/form-data">
    <div class="container">
        <h1>Přidat kategorii</h1><br>

        <label><b>Název</b></label><br>
        <input type="text" placeholder="Název kategorie..." name="name" required><br>
...
<form class="mensi" action="add_relation_script.php" method="post" enctype="multipart/form-data">
    <div class="container">
        <h1>Kategorie k produktu</h1><br>

        <label><b>Přidat kategorii</b></label><br>
        <select name="category">
            <?php
            //VÝBĚR VŠECH KATEGORIÍ A JEJICH VYPSÁNÍ DO SEZNAMU MOŽNOSTÍ
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<option value=\"\">Nenalezeny žádné kategorie</option>";
            }
            ?>
        </select><br>

        <label><b>k produktu</b></label><br>
        <select name="product">
            <?php
            //VÝBĚR VŠECH PRODUKTŮ A JEJICH VYPSÁNÍ JAKO MOŽNOSTI
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<option value=\"\">Nenalezeny žádné produkty</option>";
            }
            ?>
        </select><br>
